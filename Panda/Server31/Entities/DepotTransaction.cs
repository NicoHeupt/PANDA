...
namespace Server31.Entities
{
    ...
    {
        public int DepotTransactionId { get; set; }
        ...
        /// </summary>
        [NotMapped]
        public string ReasonString => $"{VerbString} von {Amount} × {ProductId} à {Price.ToString("C")}";
        ...
        {
            Depot = trader.Depot;
            DepotId = trader.Depot.DepotId;
            Product = marketProduct.Product;
            ProductId = marketProduct.Product.ProductId;
            Amount = amountPieces;
